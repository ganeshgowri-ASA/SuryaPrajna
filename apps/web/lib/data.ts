...
export const skills: Skill[] = [
  ...
  { id: "warranty-analysis", name: "warranty-analysis", description: "Warranty reserve and claim rate calculation", pack: "pv-reliability", packLabel: "Reliability & Quality", status: "available", tags: ["warranty", "reserve", "claim-rate", "finance"], agent: "Nityata-Agent" },

  // pv-analytics (all planned)
  { id: "anova-analysis", name: "anova-analysis", description: "Analysis of Variance for PV experiments and process control", pack: "pv-analytics", packLabel: "Statistical Analysis", status: "available", tags: ["anova", "statistics", "variance", "experiment"], agent: "Cross-cutting" },
  { id: "regression-modeler", name: "regression-modeler", description: "Linear/nonlinear regression for PV data analysis", pack: "pv-analytics", packLabel: "Statistical Analysis", status: "available", tags: ["regression", "statistics", "modeling", "data"], agent: "Cross-cutting" },
  { id: "spc-charts", name: "spc-charts", description: "Statistical Process Control charts for manufacturing quality", pack: "pv-analytics", packLabel: "Statistical Analysis", status: "available", tags: ["spc", "control-chart", "quality", "manufacturing"], agent: "Cross-cutting" },
  { id: "monte-carlo", name: "monte-carlo", description: "Monte Carlo simulation for uncertainty quantification", pack: "pv-analytics", packLabel: "Statistical Analysis", status: "available", tags: ["monte-carlo", "uncertainty", "simulation", "statistics"], agent: "Cross-cutting" },
  { id: "gum-uncertainty", name: "gum-uncertainty", description: "GUM framework uncertainty analysis for PV measurements", pack: "pv-analytics", packLabel: "Statistical Analysis", status: "available", tags: ["gum", "uncertainty", "measurement", "metrology"], agent: "Cross-cutting" },

  // pv-finance (all planned)
  { id: "lcoe-calculator", name: "lcoe-calculator", description: "Levelized Cost of Energy calculation for PV projects", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["lcoe", "finance", "cost", "energy"], agent: "Nivesha-Agent" },
  { id: "financial-modeler", name: "financial-modeler", description: "IRR, NPV, and payback period analysis for solar investments", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["irr", "npv", "payback", "finance"], agent: "Nivesha-Agent" },
  { id: "carbon-credits", name: "carbon-credits", description: "Carbon credit and REC calculations for solar projects", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["carbon", "rec", "credits", "esg"], agent: "Nivesha-Agent" },
  { id: "policy-compliance", name: "policy-compliance", description: "ALMM, DCR, and MNRE guideline compliance analysis", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["almm", "dcr", "mnre", "policy", "india"], agent: "Nivesha-Agent" },
  { id: "bankability-assessment", name: "bankability-assessment", description: "Project bankability evaluation for lender requirements", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["bankability", "lender", "project-finance", "due-diligence"], agent: "Nivesha-Agent" },
  { id: "ppa-modeler", name: "ppa-modeler", description: "Power Purchase Agreement financial modeling and scenario analysis", pack: "pv-finance", packLabel: "Finance & Economics", status: "available", tags: ["ppa", "power-purchase", "tariff", "contract"], agent: "Nivesha-Agent" },
  ...
  { id: "energy-yield", name: "energy-yield", description: "Annual energy yield simulation with loss model and PR estimation", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["energy-yield", "annual", "pr", "loss-model"], agent: "Phala-Agent" },
  { id: "p50-p90-analysis", name: "p50-p90-analysis", description: "Exceedance probability (P50/P90) analysis for project bankability", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["p50", "p90", "exceedance", "probability", "bankability"], agent: "Phala-Agent" },
  { id: "loss-tree", name: "loss-tree", description: "Energy loss tree construction and waterfall diagram analysis", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["loss-tree", "waterfall", "shading", "soiling", "mismatch"], agent: "Phala-Agent" },
  { id: "pr-monitoring", name: "pr-monitoring", description: "Performance Ratio calculation and operational monitoring", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["pr", "performance-ratio", "monitoring", "kpi"], agent: "Phala-Agent" },
  { id: "weather-data-ingestion", name: "weather-data-ingestion", description: "TMY, MERRA-2, ERA5, and NSRDB weather data ingestion and processing", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["tmy", "merra2", "era5", "nsrdb", "weather"], agent: "Megha-Agent" },
  { id: "irradiance-modeler", name: "irradiance-modeler", description: "GHI/DNI/DHI decomposition and plane-of-array transposition", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["ghi", "dni", "dhi", "irradiance", "transposition"], agent: "Megha-Agent" },
  { id: "solar-resource-assessment", name: "solar-resource-assessment", description: "Site solar resource evaluation and long-term variability analysis", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["solar-resource", "site-assessment", "variability", "climate"], agent: "Megha-Agent" },
  { id: "energy-forecasting", name: "energy-forecasting", description: "Statistical and ML-based energy generation forecasting", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["forecasting", "ml", "statistical", "prediction"], agent: "Phala-Agent" },
  { id: "iv-diagnostics", name: "iv-diagnostics", description: "Field IV curve tracing and fault diagnosis for operating plants", pack: "pv-energy", packLabel: "Energy & Weather", status: "available", tags: ["iv-curve", "diagnostics", "field", "fault"], agent: "Phala-Agent" },

  // pv-plant-design (all planned)
  { id: "array-layout", name: "array-layout", description: "Ground-mount array layout optimization for maximum yield", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["layout", "ground-mount", "optimization", "gcr"], agent: "Vinyasa-Agent" },
  { id: "rooftop-design", name: "rooftop-design", description: "Rooftop system design and layout for commercial/industrial roofs", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["rooftop", "commercial", "industrial", "design"], agent: "Vinyasa-Agent" },
  { id: "floating-solar", name: "floating-solar", description: "Floating PV (FPV) system design for reservoirs and water bodies", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["floating", "fpv", "reservoir", "aquatic"], agent: "Vinyasa-Agent" },
  { id: "shading-analysis", name: "shading-analysis", description: "Horizon, inter-row, and near-field shading analysis", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["shading", "inter-row", "horizon", "near-field"], agent: "Vinyasa-Agent" },
  { id: "string-sizing", name: "string-sizing", description: "String sizing and inverter matching for optimal MPPT operation", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["string-sizing", "inverter", "mppt", "electrical"], agent: "Vinyasa-Agent" },
  { id: "sld-generator", name: "sld-generator", description: "Single Line Diagram generation for PV plant electrical design", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["sld", "single-line", "diagram", "electrical"], agent: "Vinyasa-Agent" },
  { id: "cable-sizing", name: "cable-sizing", description: "Cable sizing, voltage drop, and routing for DC/AC circuits", pack: "pv-plant-design", packLabel: "Plant Design", status: "available", tags: ["cable", "voltage-drop", "dc", "ac", "sizing"], agent: "Vinyasa-Agent" },

  // pv-power-systems (all planned)
  { id: "load-flow-analysis", name: "load-flow-analysis", description: "Power flow and load flow studies for grid-connected systems", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["load-flow", "power-flow", "grid", "analysis"], agent: "Vidyut-Agent" },
  { id: "hybrid-modeling", name: "hybrid-modeling", description: "Solar + wind + battery + diesel hybrid system modeling", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["hybrid", "wind", "battery", "diesel", "microgrid"], agent: "Vidyut-Agent" },
  { id: "mppt-analysis", name: "mppt-analysis", description: "MPPT algorithm comparison and performance analysis", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["mppt", "algorithm", "perturb-observe", "incremental-conductance"], agent: "Vidyut-Agent" },
  { id: "inverter-modeling", name: "inverter-modeling", description: "Inverter efficiency curve modeling and sizing optimization", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["inverter", "efficiency", "sizing", "string", "central"], agent: "Vidyut-Agent" },
  { id: "bess-sizing", name: "bess-sizing", description: "Battery Energy Storage System sizing and optimization", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["bess", "battery", "storage", "sizing"], agent: "Vidyut-Agent" },
  { id: "grid-integration", name: "grid-integration", description: "Grid code compliance and interconnection study", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["grid", "interconnection", "grid-code", "compliance"], agent: "Vidyut-Agent" },
  { id: "power-quality", name: "power-quality", description: "Harmonics, THD, and power factor analysis for grid compliance", pack: "pv-power-systems", packLabel: "Power Systems", status: "available", tags: ["power-quality", "harmonics", "thd", "power-factor"], agent: "Vidyut-Agent" },

  // pv-sustainability (all planned)
  { id: "carbon-calculator", name: "carbon-calculator", description: "Carbon footprint and offset calculations for PV projects", pack: "pv-sustainability", packLabel: "Sustainability & ESG", status: "available", tags: ["carbon", "footprint", "offset", "emissions"], agent: "Grantha-Agent" },
  { id: "lca-assessment", name: "lca-assessment", description: "Life Cycle Assessment for PV modules and systems", pack: "pv-sustainability", packLabel: "Sustainability & ESG", status: "available", tags: ["lca", "lifecycle", "embodied-energy", "epbt"], agent: "Grantha-Agent" },
  { id: "esg-reporting", name: "esg-reporting", description: "ESG metrics and reporting for solar project stakeholders", pack: "pv-sustainability", packLabel: "Sustainability & ESG", status: "available", tags: ["esg", "reporting", "sustainability", "metrics"], agent: "Grantha-Agent" },
  { id: "recycling-planner", name: "recycling-planner", description: "End-of-life recycling and circular economy planning for PV", pack: "pv-sustainability", packLabel: "Sustainability & ESG", status: "available", tags: ["recycling", "end-of-life", "circular-economy", "waste"], agent: "Grantha-Agent" },
  { id: "policy-framework", name: "policy-framework", description: "National and international solar policy analysis and compliance", pack: "pv-sustainability", packLabel: "Sustainability & ESG", status: "available", tags: ["policy", "regulation", "mnre", "iec", "bis"], agent: "Grantha-Agent" },
];
