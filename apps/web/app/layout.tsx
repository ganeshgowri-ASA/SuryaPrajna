    ...
    <html lang="en">
      <body>
        ...
        <footer className="border-t border-gray-800/60 mt-20 py-8 px-6 text-center text-gray-600 text-sm">
          <p>
            SuryaPrajna &mdash; Sanskrit:{" "}
            <span className="text-amber-600/70">सूर्यप्रज्ञा</span> &ldquo;Solar
            Wisdom&rdquo; &mdash; Universal PV scientific skills following the{" "}
            <a
